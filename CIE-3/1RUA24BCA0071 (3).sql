...
/*'root@localhost', 'RVU-PC-013', '8.4.6', '2025-09-29 11:35:08'*/
...
-- Write the SQL Statement for the above Question
SELECT job_id, (min_salary + max_salary) / 2 AS average_salary
FROM jobs;


-- Paste the output of above code and comment your output
/*# job_id, average_salary
'AC_ACCOUNT', '6600.0000'
'AC_MGR', '12100.0000'
'AD_ASST', '4500.0000'
'AD_PRES', '30000.0000'
'AD_VP', '22500.0000'
'FI_ACCOUNT', '6600.0000'
'FI_MGR', '12100.0000'
'HR_REP', '6500.0000'
'IT_PROG', '7000.0000'
'MK_MAN', '12000.0000'
...
-- Write the SQL Statement for the above Question
SELECT job_id, job_title, (min_salary + max_salary) / 2 AS avg_salary
FROM jobs
...
-- Paste the output of above code and comment your output
/*# job_id, job_title, avg_salary
'AC_MGR', 'Accounting Manager', '12100.0000'
'AD_PRES', 'President', '30000.0000'
'AD_VP', 'Administration Vice President', '22500.0000'
'FI_MGR', 'Finance Manager', '12100.0000'
'MK_MAN', 'Marketing Manager', '12000.0000'
'PU_MAN', 'Purchasing Manager', '11500.0000'
'SA_MAN', 'Sales Manager', '15000.0000'
'SA_REP', 'Sales Representative', '9000.0000'*/
...
-- Paste the output of above code and comment your output
/*# department_id, avg_commission_pct
NULL, '0.150000'
'80', '0.225000'*/
